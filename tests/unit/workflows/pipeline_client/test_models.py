...
from deepset_cloud_sdk.workflows.pipeline_client.models import PipelineInputs, PipelineOutputs, PipelineType, PublishConfig
...
class TestPublishConfig:
    ...
    def test_publish_pipeline_without_query(self) -> None:
        ...
        with pytest.raises(ValidationError, match=".*Query pipelines must define components expecting a query as input*"):
            PublishConfig(
                name="test_pipeline",
                pipeline_type=PipelineType.PIPELINE,
                inputs=PipelineInputs()
